...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "Attendez 30 secondes...";
    updateSubtitle("Laissez la pointe s'enflammer uniformément afin de former une braise tout autour. Cela permettra de libérer le parfum plus intensément. Éteignez ensuite la flamme d'un souffle léger.");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "Soufflez"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "Éteindre";
    updateSubtitle("Laissez-le brûler pendant 20 à 30 minutes et diffusez le parfum en soufflant doucement la fumée avec votre main."
        + " Puis éteignez la pointe en la retournant dans la base.");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "Retournement...";
    updateSubtitle("Le sillage qui en résulte persistera pendant une journée ou plus.");
