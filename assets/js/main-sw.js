...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "Subiri kwa sekunde 30...";
    updateSubtitle("Acha ncha iwake moto vizuri ili itengeneze kikaa. "
        + "Hii itasaidia kutoa harufu vizuri zaidi. Kisha zima mwali wa moto kwa kuupuliza taratibu.");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "Puliza ncha"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "Zima na ukishe";
    updateSubtitle("Acha ifukize kwa dakika 20 hadi 30 na ueneze harufu kwa kupepea moshi taratibu kwa mkono wako."
        + " Kisha zima ncha kwa kuipindua ndani ya sehemu ya chini.");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "Kugeuza kijiti";
    updateSubtitle("Harufu yake itadumu kwa siku nzima au zaidi.");
    startBtn.style.pointerEvents = "none";
    if (pulseTween) pulseTween.kill();
    const flipTL = gsap.timeline({
        onComplete: () => {
            startBtn.innerText = "Washa";
