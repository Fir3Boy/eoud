...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "30 سیکنڈ انتظار کریں...";
    updateSubtitle("ٹپ کو برابر آگ پکڑنے دیں اور اس کے گرد ایک انگارہ بننے دیں۔ اس سے خوشبو کے بہتر پھیلاؤ میں مدد ملے گی۔ پھر آہستہ سے پھونک مار کر آگ بجھا دیں");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "سرے پر پھونک ماریں"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "بجھائیں اور گل کریں";
    updateSubtitle("اسے 20 سے 30 منٹ تک سلگنے دیں اور اپنے ہاتھ سے دھویں کو ہلکے سے پھیلا کر خوشبو کو بکھیریں۔ پھر اس کے سرے کو بیس (بنیاد) میں پلٹ کر بجھا دیں");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "سٹک کو پلٹنا";
    updateSubtitle("اس کی خوشبو کا اثر ایک دن یا اس سے زیادہ دیر تک برقرار رہے گا");
    startBtn.style.pointerEvents = "none";
    if (pulseTween) pulseTween.kill();
    const flipTL = gsap.timeline({
        onComplete: () => {
            startBtn.innerText = "روشن کریں";
