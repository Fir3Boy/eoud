...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "30 soniya kuting...";
    updateSubtitle("Tayoqcha uchi bir tekis yonishiga va uning atrofida cho'g' hosil bo'lishiga imkon bering. Bu iforning yanada samarali taralishiga yordam beradi. So'ngra, alanganing ustiga sekin puflab uni o'chiring.");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "Puflang"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "O'chirish";
    updateSubtitle("Uni 20-30 daqiqa davomida tutatib qo'ying va tutunni qo'lingiz bilan ohista hilpillatib, iforini tarating. So'ngra tayoqchaning uchini asosiga (poydevoriga) teskari qilib qo'yish orqali o'chiring.");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "Ag'darish...";
    updateSubtitle("Hosil bo'lgan ifor izi bir kun yoki undan ko'proq vaqt davomida saqlanib qoladi.");
    startBtn.style.pointerEvents = "none";
    if (pulseTween) pulseTween.kill();
    const flipTL = gsap.timeline({
        onComplete: () => {
            startBtn.innerText = "Yoqing";
