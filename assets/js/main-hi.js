...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "30 सेकंड प्रतीक्षा करें...";
updateSubtitle("सिरे को समान रूप से आग पकड़ने दें, और उसके चारों ओर अंगारा बनने दें। "
    + "इससे सुगंध अधिक प्रभावी ढंग से मुक्त होगी। फिर धीरे से फूंक मारकर लौ बुझा दें।");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "सिरे पर फूंक मारें"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "बुझाएं और शांत करें";
updateSubtitle("इसे २० से ३० मिनट तक सुलगने दें और अपने हाथ से धीरे-धीरे धुएं को फैलाकर सुगंध का आनंद लें।" 
    + " फिर सिरे को बेस में पलटकर बुझा दें।");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "स्टिक को पलटा जा रहा है";
updateSubtitle("इसकी सुगंध का प्रभाव एक दिन या उससे अधिक समय तक बना रहेगा।");
    startBtn.style.pointerEvents = "none";
    if (pulseTween) pulseTween.kill();
    const flipTL = gsap.timeline({
        onComplete: () => {
            startBtn.innerText = "प्रज्वलित";
