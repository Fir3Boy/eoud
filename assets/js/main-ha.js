...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "Dakata na tsawon sakan talatin...";
    updateSubtitle("Ka bar kan ya kama wuta sosai har sai ya yi garwashin wuta a zagaye. Wannan zai taimaka wajen fitar da kamshin yadda ya kamata. Sannan ka kashe wutar ta hanyar busawa a hankali.");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "Hura"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "Saka ka kashe";
    updateSubtitle("Bar shi ya yi hayaƙi na tsawon minti ashirin zuwa talatin, sannan ka rarraba ƙamshin ta hanyar fiffita hayaƙin a hankali da hannunka. Bayan haka, sai ka kashe wutar ta hanyar juya kansa a cikin mazaunin.");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "Juya karan...";
    updateSubtitle("Kamshin da za a bari zai dore na tsawon yini guda ko fiye da haka.");
    startBtn.style.pointerEvents = "none";
    if (pulseTween) pulseTween.kill();
    const flipTL = gsap.timeline({
        onComplete: () => {
            startBtn.innerText = "Kunna";
