...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "Tunggu selama 30 detik...";
    updateSubtitle("Biarkan ujungnya terbakar merata hingga membentuk bara di sekelilingnya. Hal ini akan membantu aroma keluar dengan lebih efektif. Kemudian, padamkan nyala api dengan tiupan perlahan.");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "Tiup"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "Padamkan";
    updateSubtitle("Biarkan bara api mengepul selama 20 hingga 30 menit dan sebarkan aromanya dengan mengibaskan asap secara perlahan menggunakan tangan Anda. Kemudian, padamkan ujungnya dengan membalikkannya ke dalam wadah.");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "Membalikkan...";
    updateSubtitle("Aroma yang dihasilkan akan bertahan selama sehari atau lebih.");
    startBtn.style.pointerEvents = "none";
    if (pulseTween) pulseTween.kill();
    const flipTL = gsap.timeline({
        onComplete: () => {
            startBtn.innerText = "Nyalakan";
