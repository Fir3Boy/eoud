...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "۳۰ ثانیه صبر کنید";
    updateSubtitle("اجازه دهید نوک آن به طور یکنواخت آتش بگیرد و در اطراف آن اخگر ایجاد شود. این کار به پخش موثرتر رایحه کمک می‌کند. سپس شعله را با دمیدن ملایم خاموش کنید");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "به نوک آن بدمید"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "خاموش و خفه کنید";
    updateSubtitle("اجازه دهید ۲۰ تا ۳۰ دقیقه به آرامی بسوزد و دود کند؛ سپس با حرکت ملایم دست، دود را پخش کنید تا عطر آن در فضا بپیچد. در نهایت، با برگرداندن نوک آن در پایه، شعله را خاموش کنید");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "برگرداندن چوب";
    updateSubtitle("رد بوی حاصل برای یک روز یا بیشتر باقی خواهد ماند");
