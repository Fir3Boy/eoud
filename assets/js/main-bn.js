...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "৩০ সেকেন্ড অপেক্ষা করুন...";
updateSubtitle("আগরউডের অগ্রভাগটি সমানভাবে জ্বলতে দিন যাতে চারপাশে একটি লাল আভা তৈরি হয়। "
    + "এটি সুগন্ধটি আরও কার্যকরভাবে ছড়িয়ে দিতে সাহায্য করবে। তারপর আলতো করে ফুঁ দিয়ে শিখাটি নিভিয়ে দিন।");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "মাথায় ফুঁ দিন"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "নিভিয়ে ফেলুন"; 
updateSubtitle("এটি ২০ থেকে ৩০ মিনিটের জন্য ধীরগতিতে জ্বলতে দিন এবং হাত দিয়ে আলতো করে বাতাস দিয়ে সুগন্ধ ছড়িয়ে দিন।"
    + " তারপর অগ্রভাগটি উল্টে বেসের ভেতরে চেপে ধরে নিভিয়ে ফেলুন।");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "কাঠিটি উল্টানো হচ্ছে";
updateSubtitle("এর সুগন্ধের রেশ একদিন বা তারও বেশি সময় ধরে থাকবে।");
    startBtn.style.pointerEvents = "none";
    if (pulseTween) pulseTween.kill();
    const flipTL = gsap.timeline({
        onComplete: () => {
            startBtn.innerText = "জ্বালানো";
