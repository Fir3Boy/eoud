...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "Wait for 30 seconds...";
    updateSubtitle("Let the tip catch fire evenly, and create an ember around the tip. "
        + "This will help release the scent more effectively. Then extinguish the flame by blowing gently");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "Blow"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "Snuff";
    updateSubtitle("Let it smolder for 20 to 30 minute and diffuse the scent by gently wafting the smoke with your hand."
        + " Then snuff the tip by flipping it into the base.");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "Flipping...";
    updateSubtitle("The resulting sillage will linger for a day or more.");
