...
function handleIgnition() {
    state = 1;
    startBtn.innerText = "30 saniye bekleyin...";
    updateSubtitle("Ucun her tarafa eşit şekilde alev almasını sağlayın ve ucun etrafında bir köz oluşturun. Bu, kokunun daha etkili bir şekilde yayılmasına yardımcı olacaktır. Ardından, hafifçe üfleyerek alevi söndürün.");
    ...
    tl.to(startBtn, { pointerEvents: "none", opacity: 0.8, duration: 0.1 })
        ...
        .to(startBtn, {
            ...
            onStart: () => { startBtn.innerText = "Üflemek"; }
        });
}

function handleBlow() {
    state = 2;
    startBtn.innerText = "Söndürmek";
    updateSubtitle("20 ila 30 dakika boyunca tütmesine izin verin ve elinizle dumanı hafifçe yelpazeleyerek kokuyu yayın. Ardından, ucu altlığın içine doğru çevirerek söndürün.");
...
function handleReset() {
    state = 0;
    startBtn.innerText = "Çeviriliyor...";
    updateSubtitle("Oluşan koku izi bir gün veya daha fazla kalıcı olacaktır.");
    startBtn.style.pointerEvents = "none";
    if (pulseTween) pulseTween.kill();
    const flipTL = gsap.timeline({
        onComplete: () => {
            startBtn.innerText = "Ateşle";
